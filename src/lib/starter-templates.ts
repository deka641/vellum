...
export type StarterPageKey = "homepage" | "about" | "contact" | "blog" | "services" | "faq" | "pricing";

export const STARTER_PAGE_CONFIG: Record<StarterPageKey, { title: string; slug: string; isHomepage: boolean; showInNav: boolean; sortOrder: number }> = {
...
export function makeStarterBlocks(pageKey: string, siteName: string) {
  switch (pageKey) {
    case "homepage": {
