  ...
  if (submitted) {
    return (
      <div className={styles.formBlock} role="status" aria-live="polite">
        <div className={`${styles.formSuccess} ${styles.formSuccessAnimated}`}>
          <svg className={styles.formSuccessIcon} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
            <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14" />
            <polyline points="22 4 12 14.01 9 11.01" />
          </svg>
          <p>{successMessage || "Thank you! Your submission has been received."}</p>
        </div>
        <button
          type="button"
